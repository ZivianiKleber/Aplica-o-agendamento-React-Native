        ...
        <View style = {styles.container}>
            ...
            <View>
                <View style = {{bottom:63}}>
                    ...
                    <TextInput placeholder= 'NOME' style = {styles.campo}></TextInput>
                    <Text style = {styles.texto}>E-MAIL</Text>
                    <TextInput  placeholder= 'E-MAIL' style = {styles.campo}></TextInput>
                </View>
            </View>
            <View style = {{top:10,justifyContent:'space-around', flexDirection:'row'}} >
                <Button mode = 'contained' color = '#F55959' style = {styles.botaoVoltar}><Text style = {styles.texto}>SAIR</Text></Button>
